...
<meta content="aframe/build/aframe-ar-nft.js · master · AR / AR.Js" property="og:title">
<meta content="GitLab.com" property="og:description">
<meta content="https://gitlab.com/ar20/AR.js/-/avatar" property="og:image">
<meta content="64" property="og:image:width">
<meta content="64" property="og:image:height">
<meta content="https://gitlab.com/ar20/AR.js/-/blob/master/aframe/build/aframe-ar-nft.js" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="aframe/build/aframe-ar-nft.js · master · AR / AR.Js" property="twitter:title">
<meta content="GitLab.com" property="twitter:description">
<meta content="https://gitlab.com/ar20/AR.js/-/avatar" property="twitter:image">

<title>aframe/build/aframe-ar-nft.js · master · AR / AR.Js · GitLab</title>
...
<script nonce="2TOhF4w1ryp4Jcn6eeZneg==">
//<![CDATA[
...
<meta name="csrf-token" content="LN8gOFjAmGR8c1m72zeC9dr/VeQJRu1dXUnVTRGJPBs100mjyX80jqDClZYmDC/O6Lk/bJ+rrkEUhe4VoaiFDQ==" />
<meta name="csp-nonce" content="2TOhF4w1ryp4Jcn6eeZneg==" />
...
<body class="ui-indigo tab-width-8  gl-browser-chrome gl-platform-windows" data-find-file="/ar20/AR.js/-/find_file/master" data-group="" data-namespace-id="7814580" data-page="projects:blob:show" data-page-type-id="master/aframe/build/aframe-ar-nft.js" data-project="AR.js" data-project-id="18495844">
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/ar20/AR.js/-/blob/master/aframe/build/aframe-ar-nft.js">Repository</a></h2>
</li>
</ul>
</div>
...
<div class="js-signature-container" data-signatures-path="/ar20/AR.js/-/commits/da5ea830211c323a41ebd55a97b99f85add1cd40/signatures?limit=1"></div>
...
<input type="hidden" name="path" id="path" value="aframe/build/aframe-ar-nft.js" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/ar20/AR.js/-/tree/master/aframe/build">build</a>
</li>
<li class="breadcrumb-item">
<a href="/ar20/AR.js/-/blob/master/aframe/build/aframe-ar-nft.js"><strong>aframe-ar-nft.js</strong>
</a></li>
</ul>
</div>
...
<span>Find file</span>
</a><a class="btn js-blob-blame-link" href="/ar20/AR.js/-/blame/master/aframe/build/aframe-ar-nft.js">Blame</a><a class="btn" href="/ar20/AR.js/-/commits/master/aframe/build/aframe-ar-nft.js">History</a><a class="btn js-data-file-blob-permalink-url" href="/ar20/AR.js/-/blob/da5ea830211c323a41ebd55a97b99f85add1cd40/aframe/build/aframe-ar-nft.js">Permalink</a></div>
</div>

<div class="info-well d-none d-sm-block">
<div class="well-segment">
<ul class="blob-commit-info">
<li class="commit flex-row js-toggle-container" id="commit-da5ea830">
...
<a class="commit-row-message item-title js-onboarding-commit-item " href="/ar20/AR.js/-/commit/da5ea830211c323a41ebd55a97b99f85add1cd40">3.0.2</a>
<span class="commit-row-message d-inline d-sm-none">
&middot;
da5ea830
</span>
<div class="committer">
<a class="commit-author-link js-user-link" data-user-id="1645773" href="/nicolocarpignoli">Nicolò Carpignoli</a> authored <time class="js-timeago" title="Mar 25, 2020 4:18pm" datetime="2020-03-25T16:18:36Z" data-toggle="tooltip" data-placement="bottom" data-container="body">Mar 25, 2020</time>
</div>

</div>
<div class="commit-actions flex-row">

<div class="js-commit-pipeline-status" data-endpoint="/ar20/AR.js/-/commit/da5ea830211c323a41ebd55a97b99f85add1cd40/pipelines?ref=master"></div>
<div class="commit-sha-group d-none d-sm-flex">
<div class="label label-monospace monospace">
da5ea830
</div>
<button class="btn btn btn-default" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copy commit SHA" data-class="btn btn-default" data-clipboard-text="da5ea830211c323a41ebd55a97b99f85add1cd40" type="button" title="Copy commit SHA" aria-label="Copy commit SHA"><svg><use xlink:href="https://gitlab.com/assets/icons-f0dc26411f6d9ceb1d30eab71475c17cca53e166e5c0d192565c1a25af40502e.svg#copy-to-clipboard"></use></svg></button>
...
<button class="btn btn-clipboard btn-transparent" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;aframe/build/aframe-ar-nft.js&quot;,&quot;gfm&quot;:&quot;`aframe/build/aframe-ar-nft.js`&quot;}" type="button" title="Copy file path" aria-label="Copy file path"><svg><use xlink:href="https://gitlab.com/assets/icons-f0dc26411f6d9ceb1d30eab71475c17cca53e166e5c0d192565c1a25af40502e.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
2.56 MB
</small>
</div>

<div class="file-actions"><a class="btn btn-primary js-edit-blob ml-2  btn-sm" href="/ar20/AR.js/-/edit/master/aframe/build/aframe-ar-nft.js">Edit</a><a class="btn btn-inverted btn-primary ide-edit-button ml-2 btn-sm" href="/-/ide/project/ar20/AR.js/edit/master/-/aframe/build/aframe-ar-nft.js">Web IDE</a><div class="btn-group ml-2" role="group">
...
<a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/ar20/AR.js/-/raw/master/aframe/build/aframe-ar-nft.js"><svg><use xlink:href="https://gitlab.com/assets/icons-f0dc26411f6d9ceb1d30eab71475c17cca53e166e5c0d192565c1a25af40502e.svg#doc-code"></use></svg></a>
<a download="aframe/build/aframe-ar-nft.js" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/ar20/AR.js/-/raw/master/aframe/build/aframe-ar-nft.js?inline=false"><svg><use xlink:href="https://gitlab.com/assets/icons-f0dc26411f6d9ceb1d30eab71475c17cca53e166e5c0d192565c1a25af40502e.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/ar20/AR.js/-/blob/master/aframe/build/aframe-ar-nft.js">Fork</a>
...
You can
<a href="/ar20/AR.js/-/blob/master/aframe/build/aframe-ar-nft.js?expanded=true&amp;viewer=simple">load it anyway</a> or <a target="_blank" rel="noopener noreferrer" href="/ar20/AR.js/-/raw/master/aframe/build/aframe-ar-nft.js">download it</a>
instead.
</div>
</div>
...
<h3 class="page-title">Delete aframe-ar-nft.js</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/ar20/AR.js/-/blob/master/aframe/build/aframe-ar-nft.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="yHSY9Q98biPW7eCZVXrDN6EC2Ch7rR0w+3tOSozUICfRePFunsPCyQpcLLSoQW4Mk0SyoO1AXiyyt3USPPWZMQ==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-1dc07c1c02bc2986173a19c87965e13e">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-1dc07c1c02bc2986173a19c87965e13e" class="form-control js-commit-message" placeholder="Delete aframe-ar-nft.js" required="required" rows="3">
Delete aframe-ar-nft.js</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-4c5ef9c92bba80e71d71efc789547e2f" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-4c5ef9c92bba80e71d71efc789547e2f">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace aframe-ar-nft.js</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/ar20/AR.js/-/update/master/aframe/build/aframe-ar-nft.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="aYDKOzB2Dtjl1CzjXXr/kWT896Q5LEr6N8UG5LhXKmpwjKOgocmiMjll4M6gQVKqVrqdLK/BCeZ+CT28CHaTfA==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-ef4c22b9183fb1822768838b1d5583e9">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-ef4c22b9183fb1822768838b1d5583e9" class="form-control js-commit-message" placeholder="Replace aframe-ar-nft.js" required="required" rows="3">
Replace aframe-ar-nft.js</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check prepend-top-8">
<input type="checkbox" name="create_merge_request" id="create_merge_request-02f7c29f195e9fbb14a430ffa38e94e1" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-02f7c29f195e9fbb14a430ffa38e94e1">Start a <strong>new merge request</strong> with these changes
</label></div>
